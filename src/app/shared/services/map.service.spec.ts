...
describe('MapService', () => {
  ...
  it('should test the test function', async () => {
    ...
    const initialSetupBundle: SetupBundle = {
      multipleOrders: [
        { address: "60 Rue de la Chimie, 38400 Saint-Martin-d'Hères, France", orders: ['c166', 'c167'] },
        { address: "Rue Victor Hugo, 69002 Lyon, France", orders: ['c213', 'c213'] }
      ],
      deliverymen: ['MAI', 'LOL'],
      trucks: ['AB-123-CD', 'AB-123-CE'],
      coordinates: [0,0]
    }
    const toursCount = 5;
  ...
  it('should call testAllAdressesToCoords method and return results', async () => {
    ...
    const deliveries : Delivery[] = [
      {address : "60 Rue de la Chimie, 38400 Saint-Martin-d'Hères, France", orders: ['c213', 'c223'], coordinates : [
          45.193912,5.767934
        ]},
      {address : "Rue Victor Hugo, 69002 Lyon, France", orders : ['c122', 'c123'], coordinates :[45.7546655,4.830187]}
    ];
    const toursCount = 5;
  ...
  it('should call initMarker method', () => {
    // Arrange
    const delivery: Delivery = { address: "12 rue de la paix", orders: ["c166"], coordinates: [45.19407653808594, 5.768377304077148] };
  ...
  it('should call initAllMarkers method', () => {
    // Arrange
    const deliveries : Delivery[] = [
      {address : "60 Rue de la Chimie, 38400 Saint-Martin-d'Hères, France", orders: ['c213', 'c213'], coordinates : [
  ...
  it('should call makePopup method', () => {
    // App
    const delivery : Delivery  =
      {address : "12 rue de la paix", orders : ["c166"]}
